...
Page({
  ...
  onLoad: function (options) {
    ...
    let pageSize = 10
    let currPage = 1
    getSystem("https://www.jnxsdwmsj.com/api/PersonalInterface/getMyWish", { userId, sessionId, cityCode, token, searchKey, pageSize, currPage},res => {
      if(res.data.code == 0) {
        this.setData({
